  ...
  en: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "paragraph", text: "Messages submitted through the contact form are transmitted via Resend Inc., an email delivery service provider. Data is processed within the European Union (Ireland, EU West). A data processing agreement pursuant to Art. 28 GDPR has been concluded with Resend." },
  ...
  de: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "paragraph", text: "Nachrichten, die über das Kontaktformular übermittelt werden, werden über Resend Inc., einen E-Mail-Versanddienstleister, weitergeleitet. Die Datenverarbeitung erfolgt innerhalb der Europäischen Union (Irland, EU West). Mit Resend wurde ein Vertrag zur Auftragsverarbeitung gemäß Art. 28 DSGVO abgeschlossen." },
